...
.login-wel img{margin-top: 120px;display: block;width: 500px;}
.login-form {width: 350px; padding:25px 45px 75px 45px; margin:160px 0 0 120px ; background: #fff; border-radius: 12px;}
...
.el-form-item .inputtxt input{display: inline-block; height: 60px;line-height: 60px;width: 100%;padding-left: 25px; border: 0; }
.el-form-item .iconame {z-index: 999; position: absolute;top: 20px;left:0;background: url('/static/login-icon1.png') no-repeat;background-size: 21px 22px; height: 18px;width: 18px;}
.el-form-item .icopwd {z-index: 999; position: absolute;top: 20px;left:0;background: url('/static/login-icon2.png') no-repeat;background-size: 21px 22px; height: 18px;width: 18px;}
.el-form-item__error{padding-top: 10px;padding-bottom: 10px;}
.loginbtn{border-radius: 30px;display: block;margin-top: 50px; width: 100%;background: #cae6e8 }
